...
------------------------------------------------------------
	SellItems = { -- Selling Prices
		...
		['ruby_ring'] = 370,
		['sapphire_ring'] = 370,
		['diamond_ring_silver'] = 210,
		['emerald_ring_silver'] = 290,
		['ruby_ring_silver'] = 290,
		['sapphire_ring_silver'] = 290,

		['diamond_necklace'] = 295,
		['emerald_necklace'] = 370,
		['ruby_necklace'] = 370,
		['sapphire_necklace'] = 370,
		['diamond_necklace_silver'] = 210,
		['emerald_necklace_silver'] = 290,
		['ruby_necklace_silver'] = 290,
		['sapphire_necklace_silver'] = 290,

		['diamond_earring'] = 295,
		['emerald_earring'] = 370,
		['ruby_earring'] = 370,
		['sapphire_earring'] = 370,
		['diamond_earring_silver'] = 210,
		['emerald_earring_silver'] = 290,
		['ruby_earring_silver'] = 290,
		['sapphire_earring_silver'] = 290,
...
--Mining Store Items
	Items = {
		...
		items = {
			...
			{ name = "weapon_flashlight", price = 20, amount = 100, info = {}, type = "item", slot = 4, },
			{ name = "goldpan", price = 500, amount = 100, info = {}, type = "item", slot = 5, },
			{ name = "pickaxe",	price = 1000, amount = 100, info = {}, type = "item", slot = 6, },
			{ name = "miningdrill",	price = 4500, amount = 50, info = {}, type = "item", slot = 7, },
...
Crafting = {
	SmeltMenu = {
		{ ["copper"] = { ["copperore"] = 4 }, ['amount'] = 10 },
		{ ["goldingot"] = { ["goldore"] = 100 } },
		{ ["goldingot"] = { ["goldchain"] = 3 } },
		{ ["goldingot"] = { ["gold_ring"] = 4 } },
		{ ["silveringot"] = { ["silverore"] = 50 } },
		{ ["silveringot"] = { ["silverchain"] = 3 } },
		{ ["silveringot"] = { ["silver_ring"] = 4 } },
		{ ["iron"] = { ["ironore"] = 4 }, ['amount'] = 10 },
		{ ["steel"] = { ["ironore"] = 6, ["carbon"] = 2 } },
		{ ["aluminum"] = { ["can"] = 3, }, ['amount'] = 4 },
		{ ["glass"] = { ["bottle"] = 2, }, ['amount'] = 3 },
	},
	GemCut = {
